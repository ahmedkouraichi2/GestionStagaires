...
public class EmailConstant {
    ...
    public static final String USERNAME = "khaled.moutiaaDev@gmail.com";
    public static final String PASSWORD = "stack12345";
    public static final String FROM_EMAIL = "khaled.moutiaaDev@gmail.com";
